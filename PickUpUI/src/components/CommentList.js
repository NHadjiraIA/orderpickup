...
import {postComment, getCommentByRestaurant} from '../services/commentService'
      ...
      <section className={classes.postAndPostedComments}>
        <div className={classes.postComment}>
          ...
          <form className={classes.commentForm} noValidate autoComplete="off">
            <TextField id="standard-basic" label="How was your experience?" onChange={commentTextHandleChange} value={commentText}/>
            <br />
            <Button variant="contained" size='medium' className={classes.postButton} onClick={postCommentHandler}>
              Post
            </Button>
          </form>
        </div>
